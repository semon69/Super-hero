...
const Gallery = () => {
    ...
    return (
        <div className='my-10 bg-gray-200 p-3 '>
            <h1 className='text-3xl font-bold text-black text-start lg:ms-4  lg:w-full w-3/4  my-5 p-3 hover:bg-black hover:text-white'>Gallery</h1>
            <div className='text-center'>
                <h1 className='text-5xl text-black font-bold my-4'>Choose Your Favorite <br /> <span className='text-blue-800'>Toys Character</span> </h1>
            </div>
