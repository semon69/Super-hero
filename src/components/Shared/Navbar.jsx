            ...
            <div className="navbar text-orange-600 rounded max-w-7xl mx-auto">
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <ul tabIndex={0} className="menu menu-compact dropdown-content mt-3 p-2  rounded-box w-52 bg-orange-50 font-bold">
                            {navItem}
                        </ul>
                    </div>
                    <div className='flex justify-center items-center gap-2'>
                        <a className="normal-case text-xl"><img className='md:w-14 w-10 md:h-14 h-10 rounded-full' src="https://images.unsplash.com/photo-1593085512500-5d55148d6f0d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mjl8fHRveXN8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=500&q=60" alt="" /></a>
                        <h2 className='font-bold md:text-3xl text-black'>Super Heros</h2>
                    </div>
                </div>
